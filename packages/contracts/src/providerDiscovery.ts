...
// Unified cross-provider skills catalog (Forkara portable skills). Descriptors use
// `scope` to carry the origin label ("forkara", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  forkaraSkillsDir: Schema.optional(TrimmedNonEmptyString),
});
