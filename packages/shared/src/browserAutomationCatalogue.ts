...
export const BROWSER_TOOL_INSTRUCTION_COPY = {
  ...
  browser_navigate: `${BROWSER_COMMON_AGENT_GUIDANCE}${BROWSER_TAB_SCOPED_AGENT_GUIDANCE} Navigate the assigned or explicit scoped tab to an http/https URL and wait for the requested load milestone. Take a new snapshot after success or an ambiguous committed failure.`,
