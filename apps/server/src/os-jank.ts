...
import {
  ...
  prepareForkaraHomeDirectory,
} from "@forkara/shared/forkaraHome";
...
export function fixPath(
  ...
  try {
    ...
    // Cached by default: the probe result is persisted under the Forkara home and reused
...
export const resolveBaseDir = (raw: string | undefined): Effect.Effect<string> =>
  Effect.sync(() => prepareForkaraHomeDirectory({ configuredHome: raw }));
