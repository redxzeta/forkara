/**
 * AgentGateway - Forkara app-control tool surface for provider agents.
 *
 * Serves the `forkara_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Forkara itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "forkara/agentGateway/Services/AgentGateway",
) {}
