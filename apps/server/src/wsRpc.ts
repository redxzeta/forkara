...
} from "@forkara/shared/threadDetailEvents";
  ...
  AdmittedWsFeatureRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      return AdmittedWsFeatureRpcGroup.of({
        ...
        [WS_METHODS.resetExecuteHardReset]: (input) =>
          resetDepartmentEffect(
            resetDepartmentService.executeHardReset(input),
            "Failed to execute guarded hard reset",
          ),
