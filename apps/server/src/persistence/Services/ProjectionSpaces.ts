...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@forkara/contracts";
...
>()("forkara/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
