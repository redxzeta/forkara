...
// Purpose: Bridges ACP form elicitation schemas to Forkara's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Forkara's composer.
