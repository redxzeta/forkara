    ...
    Effect.gen(function* () {
                ...
                ? [
                    {
                      info: entry.info,
                      parts: entry.parts,
                    } satisfies OpenCodeMessageSnapshot & { readonly info: Record<string, unknown> },
                  ]
                : [],
            )
      ...
      const schedulePromptAcceptedWatchdog = Effect.fn("schedulePromptAcceptedWatchdog")(function* (
        ...
        yield* Effect.forEach(
            ...
            Effect.sleep(delayMs).pipe(
              Effect.flatMap(() =>
                Effect.gen(function* () {
                  ...
                  return yield* recoverOpenCodeTurnFromMessages(context, {
                    turnId: input.turnId,
          ...
          { while: (recoveredOrStopped) => recoveredOrStopped !== true, discard: true },
        ).pipe(
