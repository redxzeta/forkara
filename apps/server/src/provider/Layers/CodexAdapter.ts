...
import { forkaraSkillsDir } from "../skillsCatalog.ts";
...
// Generous by design; override with FORKARA_CODEX_TURN_IDLE_TIMEOUT_MS.
const CODEX_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "FORKARA_CODEX_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 900_000,
});
      ...
      Effect.gen(function* () {
        ...
        return (
          ...
          new CodexAppServerManager(services, {
            forkaraSkillsDir: forkaraSkillsDir(serverConfig.baseDir),
