...
//          that makes Forkara catalog skills usable on every provider.
...
import type { ProviderKind, ProviderSkillReference } from "@forkara/contracts";
