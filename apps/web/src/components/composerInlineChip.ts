...
export const COMPOSER_INLINE_SKILL_CHIP_CLASS_NAME =
  "inline-flex max-w-full select-none items-center gap-1 rounded-md bg-indigo-500/8 px-1.5 py-0.5 font-medium text-[11.5px] leading-[1.1] text-indigo-600 align-middle dark:bg-indigo-400/10 dark:text-indigo-400";
