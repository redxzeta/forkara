  ...
  return (
    <SidebarProvider defaultOpen>
      ...
      <Sidebar
        ...
        innerClassName="border-r border-border/30 bg-background/75 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-lg backdrop-saturate-150 dark:border-white/[0.03] dark:bg-background/75 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.025)]"
        transparentSurface
        resizable={{
