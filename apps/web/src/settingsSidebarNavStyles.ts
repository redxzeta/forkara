...
/** Section labels ("App", "Synara") — identical to the project list section labels ("Threads"). */
export const SETTINGS_SIDEBAR_SECTION_LABEL_CLASS_NAME = `px-2 py-1 ${SIDEBAR_SECTION_LABEL_CLASS_NAME}`;
