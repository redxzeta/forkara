...
import { isPendingInteractionResponseClaimable } from "@forkara/shared/pendingInteractions";
import {
  addThreadMarker,
  removeThreadMarker,
  setThreadMarkerDone,
...
type ReadModelThread = import("@forkara/contracts").OrchestrationReadModel["threads"][number];
